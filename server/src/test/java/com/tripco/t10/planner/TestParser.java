...
public class TestParser {
    ...
    public void testParseLat() {
        ...
        assertEquals(84.0 + (42.12 / 3600.0), parser.parseLatLong("84° 42.12\" N", true),.00000001);  //test exclude degrees from expression
        assertEquals(37.21, parser.parseLatLong("-37.21 S", true),.00000001);  //test decimal degrees plus direction
        assertEquals(0.0, parser.parseLatLong("        ",true),.00000001);
        assertEquals(0.0, parser.parseLatLong("S",true),.00000001);
    }

    @Test
    public void testParseLong() {
        assertEquals(-158.2+(20.64/60.0)+(38.1/3600.0), parser.parseLatLong("-158.2   ° 20.64 ' 38.1  ",false),.00000001);

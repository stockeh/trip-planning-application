...
public class TestParser {
    ...
    public void testParseLat() {
        ...
        assertEquals(37.0 + (42.12 / 3600.0), parser.parseLatLong("37° 42.12\" N", true),.00000001);  //test exclude degrees from expression
    ...
    public void testParseLatLongFail() {
        assertEquals(-1000, parser.parseLatLong("40.95°60' 43\" N",true),.00000001);  //test that latitude cant go over 90
        assertEquals(-1000, parser.parseLatLong("109.95°60' 43\" E",false),.00000001);  //test that longitude cant go over 180;

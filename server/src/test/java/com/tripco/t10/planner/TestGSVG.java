...
public class TestGSVG {
  ...
  public void testComputePoints() {
    ...
    assertEquals(344.4298, gsvg.computePoints(-39.05955,false), .00001);

    assertEquals(15462.428571429, gsvg.computePoints(0, true), .00001);
    assertEquals(0, gsvg.computePoints(-109, true), .00001);
    assertEquals(0, gsvg.computePoints(41, false), .00001);
  }
}
